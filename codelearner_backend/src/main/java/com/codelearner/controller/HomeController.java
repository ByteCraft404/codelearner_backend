        ...
        return String.format("""
                ...
                <head>
                    ...
                    <style>
                        ...
                        html,body{height:100%;margin:0;font-family:Inter,ui-sans-serif,system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial; background: radial-gradient(circle at 10% 10%, rgba(99,102,241,0.08), transparent 10%), var(--bg); color:#e6eef8}
                        ...
                        @media (max-width:720px){.grid{grid-template-columns:1fr;}.logo{width:56px;height:56px;font-size:22px}}
                    </style>
                </head>
                <body>
                <div class=\"wrap\">
                    <div class=\"card\">
                        ...
                        <div class=\"grid\">
                            <div class=\"main-info\">
                                ...
                                <footer>Server started at: <span class=\"time\">%s</span></footer>
                            </div>

                            <aside class=\"right-card\">
                                <h3 style=\"margin:0 0 8px 0\">Quick Actions</h3>
                                <p class=\"meta\">Commands to try from your terminal</p>
                                <pre style=\"background:transparent;border-radius:8px;padding:10px;margin-top:8px;color:#cfe8ff;overflow:auto;font-size:13px\">curl -i http://localhost:8080/\n
